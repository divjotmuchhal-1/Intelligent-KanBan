...
export default function AddTaskModal({
  ...
  const suggestTags = async () => {
    ...
    try {
      ...
      if (cleaned.length) {
        ...
        setError(
          "No tags suggested. Add at least one tag before creating the task."
        );
      }
  ...
  const handleAdd = async () => {
    ...
    const finalTags = latestTagsRef.current.length
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="row row-gap-sm mt-sm">
          ...
          <button
            ...
            onClick={suggestTags}
            disabled={
              loadingSuggest || creating || (!title.trim() && !description.trim())
            }
            title={
        ...
        {/* Tags editor */}
        <div className="row align-top row-gap-md mt-sm">
